<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.ArrayList, java.net.URLDecoder,org.embed.dto.BookDTO,org.embed.dao.BookRepository" %>
...
request.setCharacterEncoding("UTF-8");
	...
	if (n.equals("Shippiong_cartId")) 
		shipping_cartId = URLDecoder.decode((thisCookie.getValue()), "utf-8");
	
	if (n.equals("Shippiong_name")) 
		shipping_name = URLDecoder.decode((thisCookie.getValue()), "utf-8");
	
	if (n.equals("Shippiong_shippingDate")) 
		shipping_shippingDate = URLDecoder.decode((thisCookie.getValue()), "utf-8");
	
	if (n.equals("Shippiong_country")) 
		shipping_country = URLDecoder.decode((thisCookie.getValue()), "utf-8");
	
	if (n.equals("Shippiong_zipCode")) 
		shipping_zipCode = URLDecoder.decode((thisCookie.getValue()), "utf-8");
	
	if (n.equals("Shippiong_addressName")) 
