	...
	<body>
		<div class="container py-4">
			...
			<div class="row align-items-md-stretch">
				<div class="col-md-5">
					<img src="/images/<%=rs.getString("b_filename") %>" alt="imgae" style="width: 100%" />
				</div>
				
				<div class="col-md-7">
					<form name="newBook" action="/bookmarket/processUpdateBook.do" method="post" enctype="multipart/form-data">
						...
						<div class="mb-3 row">
							...
							<div class="col-sm-5">
								<input id="category" type="text" name="category" class="form-control" value='<%=rs.getString("b_category") %>'>
							</div>
						</div>
						...
						<div class="mb-3 row">
							<div class="col-sm-offset-2 col-sm-10">
								...
								<a href="/bookmarket/editBook.do?edit=update" class="btn btn-secondary">취소</a>
							</div>
						</div>
					</form>
				</div>
